...
[You should watch this video which is a nice gentle introduction to history grams.](https://youtu.be/qBigTkBLU6g?t=17){target='_blank'} [@statquestwithjoshstarmerStatQuestHistogramsClearly2017a]
...
Cor $\times$ (SD.pen / SD.bf)  | `r cor.bfneur.epin*sd(person.data$epiNeur)/sd(person.data$bfneur)`
----

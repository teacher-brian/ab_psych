---
title: "Abnormal Schedule Spring 2026"
author: "Brian Holt"
date: "`r  Sys.Date()`"
output:
  html_document:
    config:
      ...
      toc:
        ...
        before: |
          <li><a href="./">Abnormal Psychology Spring 2026 schedule</a></li>
...
# Background before we begin
  ...
  E. My intention as the instructor is to teach you ways to evaluate quality knowledge and to practice quality thinking and quality writing. The context of this endeavor is going to be in abnormal psychology.
...
H. Here is the pattern of the course: 
  ...
  1. Each week you will be given a list of things to read and a list of things to do. 
...
Think about what you want to learn, generally about abnormal psychology:
...
The goal here is for you want to understand in our class but also for us to collectively think of about what you'd like to learn in our time together.
...
We've already discussed these but I want to remind you about their existence
...
1. Skim [Textbook, Module 1: What is Abnormal Psychology?](https://opentext.wsu.edu/abnormal-psych/chapter/module-1-what-is-abnormal-psychology/){target="_blank"}

2. Dictionary/Wikipedia definitions on: 
...
Please have the following readings below,  @szasz_myth_1960, and @watters_americanization_2010  read by Tuesday of week 2 (April 14) so that we can discuss in class.

And then have read @efran_defining_2007, by Thursday, April 16.
```


<!-- 3. @efran_defining_2007 (to obtain this article, you'll need to walk through the steps found in the [Using the Library section down below in the appendix](#useLibrary) --in particular the [Periodical Locator](#PeriodicalLocator)) -->
...
3. @szasz_myth_1960 which can be found in the [syllabus]((https://docs.google.com/document/d/1-9QMbTfv5QUjsvHpcy3sJtx6nCve67J4zPbgVE9zhHE){target="_blank"}) or by using this link [Szasz link to web](http://psychclassics.yorku.ca/Szasz/myth.htm){target='_blank'}

4. Americanization of Mental Illness @watters_americanization_2010 which [can be found in our syllabus by clicking this link](https://docs.google.com/document/d/1-9QMbTfv5QUjsvHpcy3sJtx6nCve67J4zPbgVE9zhHE/edit#bookmark=id.a11215pgy49s){target='_blank'}


## Do the following

1. Introduce yourself the [Slack Introductions channel](https://abormalpsychology2026.slack.com/archives/C0ARGAF9U4S){target="_blank"}

2. Create a Google doc--just one document that you'll use over and over for the whole quarter, and give edit access to bholt@northseattle.edu, and then you will need to change the share settings so that anyone with the link can 'comment'. I'll need to explain this more in class. 

In this google doc, write something about what interests you about Abnormal psychology--just a few sentences. Be sure to give this section a title.  You can also insert a page break after this entry.

3. On the same google document, make a new page, title it, and write some thoughts down to the following prompts.  When you are done, post to the [Assignment 1 channel](https://abormalpsychology2026.slack.com/archives/C0ARA5GQVT6){target="_blank"}.

4. Read some of your classmates' posts and comment on some. 

5. Synthesize  @szasz_myth_1960 and @watters_americanization_2010.  When synthesizing, don't summarize the articles. You may assume that your audience is your class, which means they should be familiar with those articles.  Instead of summarizing, let you references do their work so you can do yours.  If this doesn't make sense, post a question to the [#muddy-point-channel](https://abormalpsychology2026.slack.com/archives/C0ARD2VRUS1){target='_blank'}.
<br />  
...
6. When you are done, create a link to your work: highlight the title of your assignment and then go to the "Insert" menu of google. In that menu, find "bookmark" and select that. Your title is now a bookmark and if you hover over it, you should see a little 'link' option.  Copy that link and post it in the  [Assignment 1](https://abormalpsychology2026.slack.com/archives/C0ARA5GQVT6){target="_blank"}.

7. And then, read @efran_defining_2007 by going to the [syllabus here](https://docs.google.com/document/d/1-9QMbTfv5QUjsvHpcy3sJtx6nCve67J4zPbgVE9zhHE/edit?tab=t.0#bookmark=id.k7nkev8mwlb3){target="_blank"}.  In your one google document, make a new title, and just write what you think the main point of the article is about and then 3 things that you didn't know, or learned.  
...
8. Read a few other students and make some comments on their post.   Use google docs to make these comments.  Highlight any part of their document and you can insert a comment. you can click and use the menu, or you can use the keyboard shortcut 'ctrl + alt +m'
...
1. [Module 2: Models of Abnormal Psychology](https://opentext.wsu.edu/abnormal-psych/chapter/module-2-models-of-abnormal-psychology/){target="_blank"}

2. [Module 3: Clinical Assessment, Diagnosis, and Treatment](https://opentext.wsu.edu/abnormal-psych/chapter/module-3-clinical-assessment-diagnosis-and-treatment/){target="_blank"}
...
1. In the one document to rule them all, write about which psychology Model from [Module 2: Models of Abnormal Psychology](https://opentext.wsu.edu/abnormal-psych/chapter/module-2-models-of-abnormal-psychology/){target="_blank"} resonates with you and why.
...
5. Post to [#week2 diagnostic issues](https://abormalpsychology2026.slack.com/archives/C0AT280301J){target="_blank"}



# Week 3 April 20 {#Week3} 
...
## Do the following  do By Thursday April April 30th before class
...
4. Post a link in the [#Anxiety Assignment week 3](https://abormalpsychology2026.slack.com/archives/C0AUSER1YDS){target="_blank"} 


# Week 4 April 27 Stress disorder transitioning to mood {#Week4} 
...
For some of you, the invitation to join into an expert research conversation may still seem easy to decline but if you accept it you'll have to think about some questions for why we write
...
## Do the following finished by May 7th
...
3. Write down 3 questions in your google doc.  Put one in the [student generated discussion](https://abormalpsychology2026.slack.com/archives/C0B0JDCTR4L){target="_blank"}

4. Post your paper in the discussion [#week4 Trauma](https://abormalpsychology2026.slack.com/archives/C0AVDBS304X){target="_blank"}


# Week 5 May 4 Mood Disorders {#Week5}



```{block, type='instructorNote'}
Tuesday, May 5, 2026, there will be no classes held for the the college.  

Faculty are expected to be doing other college work.  

Which means none of you can be required to attend any class.  For any class.  In the whole Seattle college district.  
```
...
I understand that stats can be boring, and I certainly don't promise to make it interesting.
 ...
 The list of stat videos below are actually from 2 stat videos I made.  I just chunked them by chapter.  so, you can watch the whole video if you want. 

## read/watch

A. Read [Module 4: Mood Disorders](https://opentext.wsu.edu/abnormal-psych/chapter/module-4-mood-disorders/){target="_blank"}

B. What this [playlist of videos on depression and bipolar](https://www.youtube.com/playlist?list=PLDEwZwMNQswsr6gT7c0HT9rbpW5X-lstj){target="_blank"}

  * the content in these videos are fine, but they were made just at the beginning of Covid and so their quality isn't great.  I'm using them because I'm trying to catch up some time from being sick early in the quarter and the fact we aren't meeting today.  
...
<!--   1. This one is recent, shorter, and from an Intro to Psychology class: [Fears about snakes biological or learned:](https://youtu.be/I4PiC3xvmXk){target="_blank"} -->
...
3. Put both writings (summary and questions) into your google document and then share it to the  [#Mood Meta Analysis Channel](https://abormalpsychology2026.slack.com/archives/C0B26PJBVEV){target="_blank"}

4. Put your questions into the [student generated questions channel ](https://abormalpsychology2026.slack.com/archives/C0B0JDCTR4L){target="_blank"}
  
   

# Week 6  Eating Disorders  May 11 {#Week6} 
...
* Post your work to the week 6 channel [#week 6 eating disorders](https://abormalpsychology2026.slack.com/archives/C0B3G1HC31S){target='_blank'}


# Week 7 May 18 {#Week7} 

Overlapping week between eating disorders and psychotic
...
<!-- # these are vids in panopto with commentary -->
...
* Read @harveyDualTaskInformationProcessing2006 . The link in 2006 takes you to the reference section below.  But here is the citation: 
  * Harvey, Philip D., Abraham Reichenberg, Michelle Romero, Eric Granholm, and Larry J. Siever. 2006. “Dual-Task Information Processing in Schizotypal Personality Disorder: Evidence of Impaired Processing Capacity.” Neuropsychology 20 (4): 453–60. https://doi.org/10.1037/0894-4105.20.4.453.
  ...
  this link may work: [dual task processing](https://research.ebsco.com/c/kjeny5/search/details/yzg3u7pxrf?db=pdh&limiters=None&q=DI%20%2810.1037%2F0894-4105.20.4.453%29&searchMode=boolean){target='_blank'}. but it's hard to know; the link may 'expire'.  If it doesn't work, then you will need to actually go to the correct database and use the reference info (found at bottom of this page):   You'll need to use that reference information to obtain the full text, which can be found in our library database PsychArticles. This article is contained in the [PsychArticles database](https://libguides.northseattle.edu/az.php?a=p){target='_blank'}.  So, go to [that database](https://libguides.northseattle.edu/az.php?a=p){target='_blank'} by scrolling down a bit and search for the article.
...
* post to [#Pyschotic Disorders](https://abormalpsychology2026.slack.com/archives/C0B57LCUE1Z){target="_blank"}
...
# Week 9 Personality Dis. June 1 {#Week9} 

```{block, type='instructorNote'}

Brian will be out of town June 2nd and June 3rd, however I might be able to have someone sit in
...
Also, you will need to participate in some psychological research this week.  You’ll need to 4 from this website: 
[https://canvas.seattlecolleges.edu/courses/48096](https://canvas.seattlecolleges.edu/courses/48096){target="_blank"}


If you do the first one (breathing and cognition) you only have to do 2.


## Read/watch

[Textbook personality Disorders](https://opentext.wsu.edu/abnormal-psych/chapter/module-13-personality-disorders/){target='_blank'} 

### make note of the therapy options for Borderline
...
* [PDM on Personality levels](https://northseattle.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=8d9d4140-098d-45c5-ae91-abd7013ff9f0){target='_blank'}  #this and the next few links will take you to panopto or slack
    *  This video is me narrating another video.  I think if you have questions about how personality disorders (levels of personality functioning) from a psychoanalytic perspective can interfere with behavioral interventions, this is a very simple introduction..not from me but from an analyst. 
...
* In your google doc, write 2 questions you have about personality disorders

* Post one of those questions in the [student generated discussion](https://abormalpsychology2026.slack.com/archives/C0B0JDCTR4L){target="_blank"}

* Post to  [#Personality Disorders](https://abormalpsychology2026.slack.com/archives/C0B600U1GNS){target="_blank"}


  
# Week 10  June 8 {#Week10}
...
5) Post to  [#week 10 Disc](https://canvas.seattlecolleges.edu/courses/32791/modules/items/1816771){target="_blank"}


# Week 11 June 15 {#Week11}
...
2. Post your work to the [#week11 Discussion](https://canvas.seattlecolleges.edu/courses/32791/modules/items/1816777){target="_blank"}
...
3. All work should be completed by end of day, June, 18 2025

...
That's the kind of question you can put in your one-document-to-rule, or even ask questions on the [muddy point channel](https://abnormalpsych-umw3641.slack.com/archives/C043N750A69){target="_blank"}
...
1. Introduce yourself the Slack [#introductions](https://spr23abnormalpsych.slack.com/archives/C050X10RU5D){target="_blank"} channel
...
3. On the same google document, make a new page, title it, and write some thoughts down to the following prompts.  When you are done, post to the [#week_1](https://spr23abnormalpsych.slack.com/archives/C050WV919EK){target="_blank"} slack channel by including a link to your document from step 2 above.
...
This week 2 is busy.   in an effort to prepare everybody for the remaining weeks, there's several things that we need to do.

The first is you're going to read some articles that are provocative and you'll write a bit about them. Instructions will be below.

In an effort to keep inserting a little bit of statistical and research methods content I'm going to be having you do some other, hopefully small tasks, in preparation for work that comes in a week or two.
...
2. [Diathesis stress video youtube](https://www.youtube.com/watch?v=1MaaORgCHvc){target="_blank"}

```{block, type='instructorNote'}
Please have the following readings below, @efran_defining_2007, @szasz_myth_1960, and @@watters_americanization_2010  read by Monday of week 3 (April 17) so that we can discuss in class.
```
...
<br />  
4. @szasz_myth_1960  which can be found using this link [Szasz link to web](http://psychclassics.yorku.ca/Szasz/myth.htm){target='_blank'}

5. Americanization of Mental Illness @watters_americanization_2010 which [can be found in our syllabus by clicking this link](https://docs.google.com/document/d/1-9QMbTfv5QUjsvHpcy3sJtx6nCve67J4zPbgVE9zhHE/edit#bookmark=id.a11215pgy49s){target='_blank'}
...
2. When you are done, create a link to your work: highlight the title of your assignment and then go to the "Insert" menu of google. In that menu, find "bookmark" and select that. Your title is now a bookmark and if you hover over it, you should see a little 'link' option.  Copy that link and post it in the slack channel [#week 2](https://spr23abnormalpsych.slack.com/archives/C0518H37TFF){target='_blank'} channel.

3. Read a few other students and make some comments on their post.   Use google docs to make these comments.  Highlight any part of their document and you can insert a comment. you can click and use the menu, or you can use the keyboard shortcut 'ctrl + alt +m'
...
* Not So Fast, a comment to Riskind about diagnostic schemes. @efran_not_2019  * [link to slack file](https://spr23abnormalpsych.slack.com/files/U051DVA435J/F053CE7JBR8/not_so_fast_a_response_to_raskin.pdf){target='_blank'}
...
* Intro to alternative to DSM
  ...
  * [Skim Excerpts of Chapter 1 and 2 from PDM2 @lingiardiPsychodynamicDiagnosticManual2015a; stored slack](https://spr23abnormalpsych.slack.com/files/U051DVA435J/F0535TQ9KL6/excerpts_pdm_2e.pdf){target='_blank'}  This should take you to a particular post in #resources in slack. 
     * In particular the Table on mental functioning
  * [Skim Example Personality disorders from PDM2; stored in canvas](https://spr23abnormalpsych.slack.com/files/U051DVA435J/F053F0P3NDA/pdm_e2_examples.pdf){target='_blank'}  This should take you to a particular post in #resources in slack. 
...
5. Post to [#week3](https://spr23abnormalpsych.slack.com/archives/C052XV7JFRD){target="_blank"}
...
These do not make good TV.  I'ts not fun watching other people use their workflow.  If you could watch this at quad speed, I would.  But I think the best you could hope for is double speed. 
...
# "Week 12" cleaning up June     {#Week12}

...
Secondly, you may want to know how to sign up for our slack Channel.  [You will need to use this invitation:](https://join.slack.com/t/abnormalpsych-group/shared_invite/zt-ht9aeioj-juBurild2PBRtpkQ_CR8Lw) (Links to an external site.)
...
Just a test of the emergency broad cast
```
...
1. synthesisze @efran_defining_2007 , @szasz_myth_1960, and @watters_americanization_2010
...
* Spitting in client’s soup, an article about language, concepts, personal constructs  @efran_spitting_2015

* PDM @lingiardi_psychodynamic_2015  Found here:[needs link](local.target.co)

* Epidemiology youtube [will link soon](local.target.co)

```{block,type='instructorNote'}
consider having read brian holt's excerpts from pdm2
```

* Strengths of DSM vs other schemes.  
...
1. Write some on which psychology Model from ch2 resonates with you and your experiences?

2. Write about how others (people, institutions) "spit in your soup"? Make some mention as to "What is the soup?"

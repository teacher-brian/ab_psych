---
title: "Abnormal Schedule Fall 2022"
author: "Brian Holt"
date: "`r Sys.Date()`"
output:
  html_document:
    config:
      ...
      toc:
        ...
        before: |
          <li><a href="./">Abnormal Psychology Fall 2022 schedule</a></li>
...
4. [The 9 standards of Critical thinking (in the syllabus)](https://docs.google.com/document/d/1-9QMbTfv5QUjsvHpcy3sJtx6nCve67J4zPbgVE9zhHE/edit#heading=h.9yazjukrhlar){target="_blank"}
...
That's the kind of question you can put in your one-document-to-rule, or even ask questions on the [muddy point channel](https://abnormalpsych-zvs3360.slack.com/archives/C02F14B3V8F){target="_blank"}
...
2. Write something about what interests you about Abnormal psychology in your one google doc. Be sure to give it a title.  You can also insert a page break between your writings.  [Information about using a single google document](https://rstudio-pubs-static.s3.amazonaws.com/711457_72d13aaf16ff4f0987915648b6bf47b1.html#oneToRule){target='_blank'}

3. On the same google document, make a new page, title it, and write some thoughts down to the following prompts.  When you are done, post to the [#week_1](https://northseattlea-yus1991.slack.com/archives/C03AKRTM2QY){target="_blank"} slack channel by including a link to your document from step 2 above.
...
* Szazs @szasz_myth_1960  
    * [Szasz link to web](http://psychclassics.yorku.ca/Szasz/myth.htm){target='_blank'}

* Americanization of Mental Illness @watters_americanization_2010 
    * [can be found in our syllabus by clicking this link](https://docs.google.com/document/d/1-9QMbTfv5QUjsvHpcy3sJtx6nCve67J4zPbgVE9zhHE/edit#bookmark=id.a11215pgy49s){target='_blank'}
...
2. When you are done, create a link to your work: highlight the title of your assignment and then go to the "Insert" menu of google. In that menu, find "bookmark" and select that. Your title is now a bookmark and if you hover over it, you should see a little 'link' option.  Copy that link and post it in the slack channel #week 2 channel.

3. Read a few other students and make some comments on their post.   Use google docs to make these comments.  highlight any part of their document and you can insert a comment. you can click and use the menu, or you can use the keyboard shortcut 'cntrl + alt +m'
...
This has to do with one of the reasons I dislike canvas: I have to move some files from a previous class to this one, rather than having a repository that I can use for multiple classes.  So, I have to upload similar files to new classes, which opens up the possibility of mistakes. 
...
* Not So Fast, a comment to Riskind about diagnostic schemes. @efran_not_2019
    * [link to canvas file](https://canvas.northseattle.edu/courses/2205994/files/192518787/download?download_frd=1){target='_blank'}

* Spitting in client’s soup, an article about language, concepts, personal constructs.  Please note this will hit several of the same themes in the Efran article from 2007  @efran_spitting_2015  (In the reference section, I give a link to our school database...it may or may not work.  Post to logistics for help.)
...
* Intro to alternative to DSM
  ...
  * [Skim Excerpts of Chapter 1 and 2 from PDM2 @lingiardiPsychodynamicDiagnosticManual2015a; stored in canvas](https://canvas.northseattle.edu/files/192518784){target='_blank'}  This should either open a canvas page or it will ask you to log in and download. 
     * In particular the Table on mental functioning
  * [Skim Example Personality disorders from PDM2; stored in canvas](https://canvas.northseattle.edu/files/192518785){target='_blank'} This should either open a canvas page or it will ask you to log in and download. 
  
```{block,type='blueBackground'}
In case there is trouble finding these links above, here is a link directly to the "files" section in our Canvas shell:

[https://canvas.northseattle.edu/courses/2205994/files](https://canvas.northseattle.edu/courses/2205994/files){target='_blank'}

I'm using canvas in order to protect copyright of these materials. 
```
...
3. In the one document to rule them all, list some questions about the readings above.  You don't need to re-post it. 
...
8. Opening Proquest from your home, or remotely, you will need to validate your credentials. In other words, you need to prove that your are in fact students of North Seattle before you can continue, which is why you've been prompted to your @ seattlecolleges.edu email and password. Once you do that you'll then be able to see inside of the proquest database. Then you can now search for the article.

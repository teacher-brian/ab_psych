---
title: "Abnormal Schedule Fall 2021"
author: "Brian Holt"
date: "`r Sys.Date()`"
output:
  html_document:
    config:
      ...
      toc:
        ...
        before: |
          <li><a href="./">Abnormal Psychology Fall 2021 schedule</a></li>
...
3. On the same google document, make a new page, title it, and write some thoughts down to the following prompts.  When you are done, post to the [#week_1](https://abnormalpsych-zvs3360.slack.com/archives/C02F16DLQ8P){target='_blank'} slack channel by including a link to your document from step 2 above.
...
2. When you are done, highlight the title of your assignment and then go to the "Insert" menu of google. In that menu, find "bookmark" and select that. Your title is now a bookmark and if you hover over it, you should see a little 'link' option.  Copy that link and post it in the slack channel [#week 2 channel](https://abnormalpsych-zvs3360.slack.com/archives/C02FN4NFAF6){target='_blank'}. 

3. Read a few other students and make some comments on their post. 
```{block,type='blueBackground'}
When you hover your mouse over a person's post, you should see a little floating menu.  One of the icons allows you to reply. It makes a side thread.   This keeps the channel a bit more tidy and easier to read.  
...
* Not So Fast, a comment to Riskind about diagnostic schemes. @efran_not_2019
    * [link to canvas file](https://canvas.northseattle.edu/files/179665179/download?download_frd=1){target='_blank'}
...
* Intro to alternative to DSM
  ...
  * [Skim Excerpts of Chapter 1 and 2 from PDM2 @lingiardiPsychodynamicDiagnosticManual2015a; stored in canvas](https://canvas.northseattle.edu/files/179665175){target='_blank'}
     * In particular the Table on mature functioning
  * [Skim Example Personality disorders from PDM2; stored in canvas](https://canvas.northseattle.edu/files/179665177){target='_blank'}
...
2. In your document, write about how others (people, institutions) "spit in your soup"? Make some mention as to "What is the soup?"  Post a link to your work in the [#soup](https://abnormalpsych-zvs3360.slack.com/archives/C02F95X1EP8){target='_blank'} channel
...
* Post a link in the [week 4 channel](https://abnormalpsych-zvs3360.slack.com/archives/C02H6ESJ22W){target="_blank"}. 
...
3. Post your paper in the [#Stress](https://abnormalpsych-zvs3360.slack.com/archives/C02H8LMEDL4){target="_blank"} channel.
...
## Do the following
 ...
 3. post a link in the [OCD channel](https://abnormalpsych-zvs3360.slack.com/archives/C02H6F3FM0A){target="_blank"}
 ...
 5. [Do A self-reflection Survey](https://docs.google.com/forms/d/e/1FAIpQLSdCKXCNvH-nSdnuCz0OrFUcQPZXVEugR4D5lyBiZzNKYVkANw/viewform?usp=sf_link){target="_blank"}
 ...
 6. Post a re-write of one [or two] of your past written assignments.  Please choose assignments from work completed; if you didn't get to do the synthesis paper, for example, don't use it here.   
    * Don't edit your original work.  Make a new entry in your One-google-doc to rule
    * use the channel [#re-write-self-reflection](https://abnormalpsych-zvs3360.slack.com/archives/C02HK3V75BK){target="_blank"}
...
I was asked to show how I might use tools to solve a question.  Here is a 36 minute video to that end. You might find it useful to see what I mean by "having a workflow" as a way to think critically. 
...
* Put both writings (summary and questions) into the one document and post it in channel [#meta_analysis.](https://abnormalpsych-zvs3360.slack.com/archives/C02LA798E3W){target='_blank'}



# Week 8 Eating Disorders Nov 15 {#Week8} 
...
# Week 10 Personality Dis. Nov 29 {#Week10} 
...
* [PDM on Personality levels](https://northseattle.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=8d9d4140-098d-45c5-ae91-abd7013ff9f0){target='_blank'}  #this and the next few links will take you to panopto/canvas
  1) supporting file [Levels of orgnaization](https://canvas.northseattle.edu/courses/1963336/files/150345697){target='_blank'}
  2) supporting file [Personality Disorder examples from PDM](https://canvas.northseattle.edu/courses/1963336/files/150345696){target='_blank'}
...
# Week 11 BIPOC and psychopathology Dec 6 {#Week11}
...
4) Post your work to the #Diversity channel


# Week 12 Closure.2 Dec 13 {#Week12}
...
```
Be finished by Dec 16, 5pm (technically the last business day of the the last day of the quarter)

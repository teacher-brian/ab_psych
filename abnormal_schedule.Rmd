---
title: "Abnormal Schedule Spring 2021"
author: "Brian Holt"
date: "`r Sys.Date()`"
output:
  html_document:
...
3. On the same google document, make a new page, title it, and write some thoughts down to the following prompts.  When you are done, post to the [#week_1](https://abnormalpsych-mxs4843.slack.com/archives/C01SZTFBEG6){target='_blank'} slack channel by including a link to your document from step 2 above.
...
2. When you are done, highlight the title of your assignment and then go to the "Insert" menu of google. In that menu, find "bookmark" and select that. Your title is now a bookmark and if you hover over it, you should see a little 'link' option.  Copy that link and post it in the slack channel [#week 2 channel](https://abnormalpsych-mxs4843.slack.com/archives/C01TK9N3S2V){target='_blank'}. 
...
* Not So Fast, a comment to Riskind about diagnostic schemes. @efran_not_2019.....[link to canvas file](https://canvas.northseattle.edu/files/167489848/download?download_frd=1){target='_blank'}
...
* Intro to alternative to DSM
  ...
  * [Skim Excerpts of Chapter 1 and 2 from PDM2 @lingiardiPsychodynamicDiagnosticManual2015a; stored in canvas](https://canvas.northseattle.edu/courses/2086443/files/167489846){target='_blank'}
     * In particular the Table on mature functioning
  * [Skim Example Personality disorders from PDM2; stored in canvas](https://canvas.northseattle.edu/files/167489847){target='_blank'}
...
2. In your document, write about how others (people, institutions) "spit in your soup"? Make some mention as to "What is the soup?"  Post a link to your work in the [#soup](https://abnormalpsych-mxs4843.slack.com/archives/C01TCRTHRB6){target='_blank'} channel

3. In the one document to rule them all, list some questions about the readings above.  You don't need to repost it. 
...
* Post a link in the [week 4 channel](https://abnormalpsych-mxs4843.slack.com/archives/C020A3GG84E){target="_blank"}. 
...
3. Post your paper in the [#Stress](https://abnormalpsych-mxs4843.slack.com/archives/C0216NQNT8Q){target="_blank"} channel.
...
## Do the following
 ...
 3. post a link in the [OCD channel](https://abnormalpsych-mxs4843.slack.com/archives/C020A51K546){target="_blank"}
 ...
 4. Pick 2 other students and invite them to read your post. In the invitation, think about what you might like to receive some feedback about. 
    * if you are invited to give feedback, you don't have to but should you give feedback be kind and try to adhere to the request. 
 ...
 5. [Do A self-reflection Survey](https://forms.gle/v6FwuBw1gPtXfevQ8){target="_blank"}
 ...
 6. Post a re-write of one [or two] of your past written assignments.  Please choose assignments from work completed; if you didn't get to do the synthesis paper, for example, don't use it here.   
    ...
    * use the channel [#re-write-self-reflection](https://abnormalpsych-mxs4843.slack.com/archives/C02025C0VT9){target="_blank"}
...
Final Self-reflection   (Link will be added soon)

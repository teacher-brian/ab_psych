...
Please have the following readings below, @efran_defining_2007, @szasz_myth_1960, and @@watters_americanization_2010  read by Tuesday of week 3 (Oct 10) so that we can discuss in class.
```
...
```{block,type='blueBackground'}
to find this article, you may find the following video helpful [finding Efran article](https://youtu.be/FxqcwTE0gJQ){target='_blank'}
...
2. When you are done, create a link to your work: highlight the title of your assignment and then go to the "Insert" menu of google. In that menu, find "bookmark" and select that. Your title is now a bookmark and if you hover over it, you should see a little 'link' option.  Copy that link and post it in the canvas discussion [#week 2](https://canvas.seattlecolleges.edu/courses/16722/discussion_topics/156141){target='_blank'} channel.

...
Please have @efran_defining_2007, @szasz_myth_1960, and @@watters_americanization_2010  read by Monday of week 3 (April 17) so that we can discuss in class.
```


* @efran_defining_2007 (to obtain this article, you'll need to walk through the steps found in the [Using the Library section down below in the appendix](#useLibrary) --in particular the [Periodical Locator](#PeriodicalLocator))
...
* Szazs @szasz_myth_1960  which can be found using this link [Szasz link to web](http://psychclassics.yorku.ca/Szasz/myth.htm){target='_blank'}

* Americanization of Mental Illness @watters_americanization_2010 which [can be found in our syllabus by clicking this link](https://docs.google.com/document/d/1-9QMbTfv5QUjsvHpcy3sJtx6nCve67J4zPbgVE9zhHE/edit#bookmark=id.a11215pgy49s){target='_blank'}

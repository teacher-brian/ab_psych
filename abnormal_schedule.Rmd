...
* search for a meta-analysis on a mood disorder (major, minor, persistent, bipolar (1,2) cyclothymia, dysthmia, or even the subtypes of depression (eg, Seasonal, postpartum)) and try to summarize the findings using your own words.  If you want to copy paste some of the language from the article, that is fine, but you should still try to use your own words to say it. 
...
* Write down 5 questions about the methods of the paper.  How did they do the metaanalysis?
...
# Week 9  Still under construction Nov 23 {#Week9} 

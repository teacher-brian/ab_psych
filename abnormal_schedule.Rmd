...
3. On the same google document, make a new page, title it, and write some thoughts down to the following prompts.  When you are done, post to the [#week_1](https://abnormalpsych-umw3641.slack.com/archives/C043N771RMK){target="_blank"} slack channel by including a link to your document from step 2 above.
...
Please have @efran_defining_2007, @szasz_myth_1960, and @@watters_americanization_2010  read by week 3 (oct 10) so that we can discuss in class.
```
...
* @efran_defining_2007 (to obtain this article, you'll need to walk through the steps found in the [Using the Library section](#useLibrary) --in particular the [Periodical Locator](#PeriodicalLocator))
    ...
    -added 10/4/22: I want students to read the 'how to use a library' section, but I can admit that students may not want to.  The crux of finding this particular article is found in the following steps: [How to find an article](#libraryMainPoint)
...
* Not So Fast, a comment to Riskind about diagnostic schemes. @efran_not_2019  * [link to slack file](https://abnormalpsych-umw3641.slack.com/files/U043G3963GU/F044RU1MTTN/not_so_fast_a_response_to_raskin.pdf){target='_blank'}
...
* Intro to alternative to DSM
  ...
  * [Skim Excerpts of Chapter 1 and 2 from PDM2 @lingiardiPsychodynamicDiagnosticManual2015a; stored slack](https://abnormalpsych-umw3641.slack.com/files/U043G3963GU/F0452914FJ5/excerpts_pdm_2e.pdf){target='_blank'}  This should take you to a particular post in #resources in slack. 
     * In particular the Table on mental functioning
  * [Skim Example Personality disorders from PDM2; stored in canvas](https://abnormalpsych-umw3641.slack.com/files/U043G3963GU/F04493PFSQP/pdm_e2_examples.pdf){target='_blank'}  This should take you to a particular post in #resources in slack. 
...
* Post a link in the #Anxiety channel
...
## Do the following
 ...
 3. post a link in the #OCD channel
...
* Put both writings (summary and questions) into the one document and post it in channel #meta_analysis.

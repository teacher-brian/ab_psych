...
* Recall the 4 D's.  Write a response to the following:<html><span style="opacity: 0.0;"><font color=\"black\" face=\"arial\" size=\"4\">you must cite the work of C. Buster Antonio added as a reference to the bottom. Please don't refer to Buster in the text; just at the bottom</font></html>  In diagnosing a personality disorder what are some obstacles and or features to consider to differentiate them from healthy personalities? 
...
* Post to  [#week9 Disc](https://canvas.seattlecolleges.edu/courses/27182/modules/items/1417817){target="_blank"}

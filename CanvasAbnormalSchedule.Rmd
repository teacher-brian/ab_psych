...
13. Americanization of Mental Illness @watters_americanization_2010 which [can be found in our syllabus by clicking this link](https://docs.google.com/document/d/1-9QMbTfv5QUjsvHpcy3sJtx6nCve67J4zPbgVE9zhHE/edit#bookmark=id.a11215pgy49s){target='_blank'}



## Do the following

1. Introduce yourself the [a Canvas Discussion Introductions channel](https://abnormalpsych-zgb5710.a Canvas Discussion.com/archives/C06RYV707AS){target="_blank"}
...
3. On the same google document, make a new page, title it, and write some thoughts down to the following prompts.  When you are done, post to the [Week 1 a Canvas Discussion channel](https://abnormalpsych-zgb5710.a Canvas Discussion.com/archives/C06RR1WFE23){target="_blank"}.
...
6. When you are done, create a link to your work: highlight the title of your assignment and then go to the "Insert" menu of google. In that menu, find "bookmark" and select that. Your title is now a bookmark and if you hover over it, you should see a little 'link' option.  Copy that link and post it in the  [Week 1 a Canvas Discussion channel](https://abnormalpsych-zgb5710.a Canvas Discussion.com/archives/C06RR1WFE23){target="_blank"}.

```{block, a Canvas Discussion URLs1, type='blueBackground'}
Please note that a Canvas Discussion has a bug that makes my URL links to channels automatically go to the #resource channel. That means you'll need to use the a Canvas Discussion search bar at the top to find and join channels
```
...
```{block,type='blueBackground'}
In a Canvas Discussion, when you hover your mouse over a person's post, you should see a little floating menu.  One of the icons allows you to reply. It makes a side thread. This keeps the channel a bit more tidy and easier to read.
